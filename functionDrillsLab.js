...
function emailCheck(email) {
  ...
  if (email.includes('@')) {
    ...
    return 'must proide a valid email address';
  }
}

emailCheck('123@gmail.com');
console.log(emailCheck('123@gmail.com'));
...
//CODE HERE
function ascendingArrayTester(arr) {
...
let arrayIsAscending = ascendingArrayTester(sampleArray);
